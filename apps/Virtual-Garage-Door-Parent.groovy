 ...
 *  Hubitat Port, Parent/Child Mods: D Canfield (peng1can@gmail.com), Brandon Soto (brandon.soto09@gmail.com)
 */
...
preferences {
    page(name: "mainPage", title: "Garage Doors", install: true, uninstall: true) {
        section {
